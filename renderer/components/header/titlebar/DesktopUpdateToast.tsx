    ...
    <div className="tailwind-scope tw-pointer-events-none tw-fixed tw-bottom-7 tw-right-7 tw-z-[10000] tw-w-[372px]">
      ...
      >
        <div className="tw-relative tw-z-10 tw-min-w-0 tw-pr-1 tw-text-left">
          ...
          <div className="tw-mt-0.5 tw-text-sm tw-font-semibold tw-leading-none tw-text-[#b9c0c4]">
            {viewUpdateLabel} →
          </div>
        </div>
