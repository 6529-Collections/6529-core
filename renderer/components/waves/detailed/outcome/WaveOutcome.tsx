...
export const WaveOutcome: React.FC<WaveOutcomeProps> = ({ wave, children }) => {
  ...
  return (
    <>
      <div
        ...
        } tw-transition-all tw-duration-300 lg:tw-pl-4 lg:tw-pr-4`}>
        {children}
        <div
          className={`tw-w-full no-scrollbar tw-overflow-y-auto ${contentHeight} tw-pb-6 tw-px-2 lg:tw-px-0 tw-pt-4 tw-space-y-4`}>
