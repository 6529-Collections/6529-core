  ...
  return (
    <div className="tw-relative tw-min-h-screen tw-flex tw-flex-col">
      <div
        ...
        <div
          className={`tw-h-screen lg:tw-h-[calc(100vh-5.5rem)] min-[1200px]:tw-h-[calc(100vh-8rem)] tw-flex-grow tw-flex tw-flex-col lg:tw-flex-row tw-justify-between tw-gap-x-6 tw-gap-y-4 tw-transition-all tw-duration-300`}>
