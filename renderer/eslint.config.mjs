...
// PLUGINS
// =============================================================================
// React is included via eslint-config-next, but flat config rule overrides need
// the plugin registered in the same config object.
...
export const typeCheckedFileIgnores = Object.freeze([
  "scripts/**",
  "**/next.config.*",
  "**/.next-static-export/**",
  "config/env.ts",
...
export const createEslintConfig = ({
  ...
  extraPlugins = {},
  additionalConfigs = [],
  globalIgnorePatterns = baseGlobalIgnores,
  ...
  return defineConfig([
    ...
    // Electron desktop code imports root-owned modules through tsconfig aliases
    // and uses local diagnostic logging for wallet/IPC flows.
    {
      files: [
        "components/confirm/ConfirmSeedWallet*.tsx",
        "components/core/**/*.{ts,tsx}",
        "components/header/titlebar/TitleBar.tsx",
    ...
    {
      files: ["**/*.{ts,tsx}"],
      ignores: [...typeCheckedFileIgnores],
      languageOptions: {
