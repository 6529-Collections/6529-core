...
const CORE_NFT_LOCAL_DATA_MESSAGES = objectMessages(
  "core.ethScanner.nftsData",
  {
    ...
    "supply.minted": "{minted} minted",
    "supply.mintedBurned": "{minted} minted / {burned} burned",
    "display.memes": "The Memes #{tokenId}",
    "display.gradient": "6529 Gradient #{tokenId}",
    "display.memelab": "Meme Lab #{tokenId}",
    "display.nextgen": "NextGen C{collectionId} #{tokenId}",
