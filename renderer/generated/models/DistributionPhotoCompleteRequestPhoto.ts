...
export class DistributionPhotoCompleteRequestPhoto {
    /**
    * The CloudFront URL of the uploaded photo
    */
    'media_url': string;
    ...
    static getAttributeTypeMap() {
        return DistributionPhotoCompleteRequestPhoto.attributeTypeMap;
    }
