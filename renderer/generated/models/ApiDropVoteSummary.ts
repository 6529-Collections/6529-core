...
export class ApiDropVoteSummary {
    /**
    * Omission does not imply that both vote totals are zero.
    */
    'vote_distribution'?: ApiDropVoteDistribution;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "vote_distribution",
            "type": "ApiDropVoteDistribution",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiDropVoteSummary.attributeTypeMap;
    }
