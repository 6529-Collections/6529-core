...
export const publicEnvSchema = z.object({
  ...
  BACKEND_TARGET: z.enum(["live", "test"]).optional(),
  BASE_ENDPOINT: z
    .string({
      required_error:
   ...
   * ────────────────
   */
  // 6529 Desktop supplies these through its local runtime when IPFS is enabled.
  IPFS_API_ENDPOINT: z
    .string()
    .url("IPFS_API_ENDPOINT must be a valid URL")
    .optional(),
