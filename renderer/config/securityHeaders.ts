...
function getConfiguredIpfsGatewaySource(
  ...
  return getConfiguredConnectSource(
    ipfsGatewayEndpoint,
    allowInsecureLocalhost
  );
}
...
export function createSecurityHeaders(
  ...
  ipfsGatewayEndpoint: string | undefined = "",
  mediaResolverEndpointOrOptions:
    | string
    | SecurityHeaderOptions
    | undefined = "",
  securityHeaderOptions: SecurityHeaderOptions = {}
) {
  const mediaResolverEndpoint =
    typeof mediaResolverEndpointOrOptions === "string"
      ? mediaResolverEndpointOrOptions
      : "";
  const options =
    typeof mediaResolverEndpointOrOptions === "object" &&
    mediaResolverEndpointOrOptions !== null
      ? mediaResolverEndpointOrOptions
      : securityHeaderOptions;
